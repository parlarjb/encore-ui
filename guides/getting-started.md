...
2. Include the Encore CSS file in the `<head>` of your index.html (before the CSS for your app):
    ...
    ```
    <link rel="stylesheet" href="https://95c7050854423f809e66-6999ba0e7a4f47d417515fb3f08fa9b8.ssl.cf1.rackcdn.com/encore-ui-1.25.0-v1.18.0-1-g0c04c-d.0-v1.14.0-2-gd9ae-d.0.min.css">
    ```

3. Include the Encore JS file (**Dependencies must be included before this line**):

    ```
    <script src="https://95c7050854423f809e66-6999ba0e7a4f47d417515fb3f08fa9b8.ssl.cf1.rackcdn.com/encore-ui-tpls-1.25.0-v1.18.0-1-g0c04c-d.0-v1.14.0-2-gd9ae-d.0.min.js"></script>
    ```
